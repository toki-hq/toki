...
- **Named channels** + **duplex mode** — per-frequency settings in the Channels view: a human-readable name, and **Half** (single-floor walkie-talkie, the default) vs **Full** duplex (everyone can talk at once). Mode changes hot-apply to a live room and push to its occupants.
