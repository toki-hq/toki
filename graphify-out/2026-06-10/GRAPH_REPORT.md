...
## Corpus Check
- 78 files · ~162,605 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1783 nodes · 3652 edges · 69 communities (57 shown, 12 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af8f4426`
...
Cohesion: 0.05
Nodes (96): AdminApi, audit_log_filters_by_category(), authed(), AuthInterceptor, ban_identityless_member_is_failed_precondition(), ban_machine_without_machine_hash_is_failed_precondition(), ban_records_kicks_lists_and_lifts(), ban_rejects_oversized_or_control_reason() (+88 more)

### Community 1 - "Client egui App"
Cohesion: 0.07
Nodes (62): Align2, App, Color32, Complex, Config, CornerRadius, Arc, AudioControl (+54 more)
...
Cohesion: 0.06
Nodes (64): AdminDb, audit_insert_load_filter_page_prune(), AuditRow, Backend, ban_record(), bans_insert_load_delete_round_trip(), channel_names_crud_roundtrips(), connect_with_retry() (+56 more)
...
Cohesion: 0.06
Nodes (45): AuditSink, ChallengeKey, ChangeFrequencyRequest, ChangeFrequencyResponse, ClientIdentity, Event, IpAddr, Option (+37 more)
...
Cohesion: 0.07
Nodes (36): AppState, redact_db_url(), redirect_handler(), run(), serve_redirect(), strip_host_port(), AuditEvent, AdminConfig (+28 more)
...
Cohesion: 0.10
Nodes (47): BanRecord, Channel, Option, RegisterRequest, ServerConfig, SharedBans, SignalingClient, SigningKey (+39 more)
...
Cohesion: 0.14
Nodes (25): broadcast_stream(), fill_member_identity(), mk_client(), next_generation(), run_broadcaster(), snapshot_carries_channel_names_for_all_named_freqs(), snapshot_carries_muted_flag(), snapshot_groups_clients_by_frequency() (+17 more)
...
Cohesion: 0.14
Nodes (11): ConnState, HashMap, Option, S, SharedState, ClientState, ConnState, mute_set_tracks_membership() (+3 more)
...
Cohesion: 0.11
Nodes (26): ClientIdentity, Event, HashMap, Instant, IpAddr, Option, Sender, SharedBans (+18 more)
...
Cohesion: 0.05
Nodes (65): Arc, AtomicBool, AtomicU64, BeepParams, Box, Channel, ClientConfig, Clone (+57 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (25): Option, String, Vec, Instant, Option, Result, SharedByteCounters, SharedRegistry (+17 more)
...
## Knowledge Gaps
- **546 isolated node(s):** `Layout`, `Architecture`, `Security`, `Documentation`, `Server environment variables` (+541 more)
...
- **Why does `Arc` connect `Community 67` to `Admin gRPC API`, `Watch Stream Broadcast`, `Community 59`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `custom_tls_connector()` connect `Community 67` to `Signaling Events`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **What connects `Layout`, `Architecture`, `Security` to the rest of the system?**
...
- **Should `Admin gRPC API` be split into smaller, more focused modules?**
  _Cohesion score 0.05104624816739971 - nodes in this community are weakly interconnected._
- **Should `Client egui App` be split into smaller, more focused modules?**
  _Cohesion score 0.06834189986674281 - nodes in this community are weakly interconnected._
